...
export const User = ({id, avatar, email, first_name, last_name, isInvited, handleOnClickInvite }) => (
  <li>
    <div>
    ...
    <img  onClick={() => handleOnClickInvite(id)} className="action" src={`/assets/${isInvited ? 'minus' : 'plus'}.svg`} alt="Action" />
  </li>
);
